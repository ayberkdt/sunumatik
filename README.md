...
| [`satellite_integration/`](presets/satellite_integration) | **Uydu entegrasyonu**: bir uydunun neye benzediğini değil NASIL KURULDUĞUNU anlatan patlatılmış görünüm. 33 parça türü, 43 adet, 8 alt sistem, 7 montaj adımı; her parçanın satırında nereye cıvatalandığı, hangi arayüzle (cıvata/kızak/ayırma/akışkan/ısıl/elektrik/menteşe), kaçıncı adımda geldiği, kaç kilo olduğu ve NEDEN VAR OLDUĞU yazılı. Montaj sırası keyfi değil: tank panel kapanmadan girer, ekipman panele tezgâhta takılır, MLI en son gelir çünkü altındaki cıvatalara bir daha ulaşılamaz. Patlatma yönü montajın tersidir ve parçanın ebeveynine göre konumundan türetilir. Kütle bütçesi toplanır (709,4 kg kuru + 415 kg itici = 1124,4 kg) ve kütle merkezi ayırma halkası ekseninden 32,7 mm sapar — fırlatıcı arayüz sınırının içinde. Her parçada ayrıca TEKNİK KÜNYE var: parça numarası (SD-XXX-000), malzeme, güç (üretim negatif), veri hızı, çalışma sıcaklığı bandı, bağlantı elemanı (cıvata sayısı ve torku), ısı yolu ve nitelik beyanı. Bu sayılar süs değil, toplandıklarında KAPANMAK zorunda: güç 2900 W üretim / 2054 W tüketim (%29,2 pay), veri 420 Mbps ham ÷ 4 sıkıştırma = 105 Mbps ≤ 150 Mbps indirme, ısıl 2504 W radyatör kapasitesi ≥ 1934 W atılacak (%22,8 pay). Kapasite künyeden okunmaz, radyatörün beyan edilen alanından εσT⁴ ile HESAPLANIR — künyeye elle yazılan 340 W, aynı panelin gerçekte 1252 W attığını gizliyordu. `scripts/validate-satellite.mjs` 82 denetim. |
