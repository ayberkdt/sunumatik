...
| **ORBITAL** · [stage-separation](presets/stage_separation/index.html) | İki kademeli fırlatma: olaylar gerçek tırmanış çözümünden türer; itici ayrılıp kendi balistiğini yaşar (kafes kanatçıklar açılır), kapak iki yarım hâlinde atılır; sinema yönetmeni ve `?sinema=1` temiz yakalama |
