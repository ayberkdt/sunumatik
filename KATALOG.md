...
| **ORBITAL** · [stage-separation](presets/stage_separation/index.html) | İki kademeli fırlatma + 2 katı yakıtlı itici: olaylar gerçek tırmanış çözümünden türer (SRB tükenmesi/ayrılması dahil); iticiler ve kademe ayrılıp kendi balistiklerini yaşar, kapak iki yarım hâlinde atılır; prosedürel gövde dokusu (panel dikişi, buz bandı, roll deseni); sinema yönetmeni ve `?sinema=1` temiz yakalama |
| **ORBITAL** · [mechanism-lab](presets/mechanism_lab/index.html) | Aksam laboratuvarı: 16 mekanizma için patlatılmış görünüm, kinematik iskelet (pivot + eksen okları), hareket zarfı, eklem sürgüleri ve künye (bağıntı · neden · kanıt); DOF rig haritasından türetilir |
| **ORBITAL** · [satellite-integration](presets/satellite_integration/index.html) | Uydu entegrasyonu: patlatılmış görünüm, 7 adımlık montaj akışı, parça künyeleri (neye bağlanır, hangi arayüz, kaç kilo, neden var), kütle bütçesi ve kütle merkezi — `?adim=2&patla=45` |
| **ORBITAL** · [exploded-view](presets/exploded_view/index.html) | Patlatılmış görünüm: tek montaj çekirdeği, altı cisim (uydu, yüzey üssü, gezgin, iniş aracı, roket, yörünge aracı). Beyan edilen katalog ile sahneden türetilen montaj yan yana; türetilen kütle her yerde TAHMİN diye işaretli. Etiketler kenar oluğunda, kılavuz çizgisiyle bağlı — `?cisim=habitat` |
| **ORBITAL** · [habitat-blocks](presets/habitat_blocks/index.html) | Yüzey üssü: 26 bileşen, 7 kurulum adımı, Mars ⇄ Ay ortam anahtarı. Ortama uymayan bileşen gerekçesi ve önerisiyle REDDEDİLİR (Ay'da MOXIE ve rüzgâr ölçer) ve kütle bütçesinden düşer. Hat yönlendirme hesaplanır: mesnet aralığı sarkma sınırından çıkar ve g^(−1/3) ile ölçeklenir — `?ortam=moon` |
| **ORBITAL** · [light-blocks](presets/light_blocks/index.html) | Işık fiziği: aynı lamba vakum/Mars/Dünya/iç mekânda; huzme yalnız saçan ortamda görünür, alev yalnız oksijenli ortamda yanar, dolgu hesaplanır (AmbientLight yok); ışık tablosu lux/kandela/K ile — `?ortam=mars` |
| **ORBITAL** · [life-signs](presets/life_signs/index.html) | Nefes kütüphanesi: gerçek boşta davranışların katalogu (direk bakışı hız sınırlı, üç durumlu fener, HGA sürüklenmesi, karşı korelasyonlu kamera nefesi), sahne dikkat bütçesi ve yasak sınıflar; seçili kanalın 60 s'lik gerçek izi ölçüm grafiğinde — `?davranis=roverGaze,roverBeacon&kamera=yakin&debug=1` |
| **ORBITAL** · [physical-rigs](presets/physical_rigs/index.html) | Fiziksel aksam: gezgin gerçek araziye oturarak sürer (rocker-bogie tek geçişli çözüm, diferansiyel, ω = v/(r(1−s)) kayma, temas artığı 1,9 mm), kesintisiz dönen periyodik zemin, tekerlek izi, rotor bulanıklık diski; HUD'da bütün açılar |
| **ORBITAL** · [craft-blocks](presets/craft_blocks/index.html) | Estetik parametrik araç kütüphanesi (9 araç): her ayrıntı bir mekanizma; adlı eklemler + `userData.rig` parça sözleşmesi, physical_rigs sürücüsüyle çalışan mekanizma gösterisi (rocker-bogie, Ackermann yerinde dönüş, SADA, gimbal, bal peteği strok'u, yaylı açılım, rotor bulanıklığı) ve teknik etiketler — tüm bloklar bununla birleşir |
...
| **ORBITAL** · [site-plan](presets/site_plan/index.html) | Saha yerleşimi: 11 adlandırılmış kuralla çözülen üs planı (reaktör ≥ 1 km, pist ≥ 500 m + ejecta konisi, yakıt ↔ O₂ ≥ 50 m, radyatör Güneş'e sırt…), ölçülen değer hedefiyle yan yana; modüller sürüklenebilir, kapılar araziyi tesviye eder — `?ortam=mars&seed=7&gorunum=arazi` |
| **ORBITAL** · [terrain-blocks](presets/terrain_blocks/index.html) | Arazi kütüphanesi: olgu katmanlı yükseklik alanı (krater alanı, masif, sırt, kanyon, kumul, mesa, rille), Ay/Mars profilleri, eğim kırpma, sorgulanabilir yüzey (`terrain-query`); vitrin profil · tohum · Güneş irtifası · yükseklik/eğim haritası — `?profil=moon-highland&seed=7&sun=14&export=1` |
...
| **ORBITAL** · [three-body-states](presets/three_body_states/index.html) | Üç-cisim durumları: 20 panoda periyodik çözümler (Šuvakov–Dmitrašinović, Lagrange, Euler, Broucke) + kaotik Pisagor, canlı RK4, periyodiklik denetimde |
