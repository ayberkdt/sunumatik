...
KARTLAR = [
    ...
    dict(src="stage-separation-preset", repo="stage_separation", kat="orbital",
         ...
         hook="Roket kademe atlar: MECO'dan sonra itici SAHNEYE BIRAKILIR, kafes kanatçıklarını açar ve kendi balistiğini yaşarken üst kademe vakum motoruyla devam eder.",
         feats=["Zaman çizelgesi elle yazılmaz: Max-Q, MECO, ayrılma, SES, kapak ve SECO gerçek tırmanış çözümünden türer",
